...
<head>
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{asset('bower_components/bootstrap-daterangepicker/daterangepicker.css')}}bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/index" class="logo">
            ...
            <span class="logo-lg"><b>Tutelage</b></span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018-2019 <a href="https://www.ssquare.pk/"> S-Square</a>.</strong> All rights
        reserved.
    </footer>
...
<!-- Slimscroll -->
<script src="{{asset('bower_components/jquery-slimscroll/jquery.slimscroll.min.js')}}bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
